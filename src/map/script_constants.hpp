...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(IG_CAJA1);
	export_constant(IG_CAJA2);
	export_constant(IG_CAJA3);
	export_constant(IG_CAJA4);
	export_constant(IG_CAJA5);
	export_constant(IG_CAJA6);
	export_constant(IG_CAJA7);
	export_constant(IG_CAJA8);
	export_constant(IG_CAJA9);
	export_constant(IG_CAJA10);
	export_constant(IG_CAJA11);
	export_constant(IG_CAJA12);
	export_constant(IG_CAJA13);
	export_constant(IG_CAJA14);
	export_constant(IG_CAJA15);
	export_constant(IG_CAJA16);
	export_constant(IG_CAJA17);
	export_constant(IG_CAJA18);
	export_constant(IG_CAJA19);
	export_constant(IG_CAJA20);
